				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<div class="box box-primary">
							...
							<form id='update_form' role="form" action="/admin/product/update" method="post" enctype="multipart/form-data">
								<div class="box-body">
									...
									<div class="form-group">
										...
										<input style="width:40%; margin-right:10px; display: inline-block;"
											type="number" id="pd_price" name="pd_price" class="form-control" value="<c:out value='${product.pd_price}'/>"
											placeholder="Enter price" min="0" />
										<input style="width:40%; display: inline-block;"
											type="number" id="pd_discount" name="pd_discount" class="form-control" value="<c:out value='${product.pd_discount}'/>"
											placeholder="Enter discounted price" min="0" max="100" onkeyup="$(this).val() > 100 ? $(this).val('100') : $(this).val() < 0 ? $(this).val('0') : ''" />
									</div>
									<div class="form-group">
										<label for="exampleInputPassword1">Detail</label>
										<textarea class="form-control" id="pd_content" name="pd_content" rows="8"
											placeholder="Enter ..."><c:out value='${product.pd_content}'/></textarea>
									</div>

									<div class="form-group">
										<label for="exampleInputEmail1">Thumbnail Image</label> <input
											type="file" id="file1" name="file1" class="form-control" />
										<input type="hidden" id="pd_image" name="pd_image" class="form-control" value="<c:out value='${product.pd_image}'/>"/>
									</div>
									...
									<div class="form-group">
										...
										<input style="width:30%; margin-right:10px; display: inline-block;"
											type="number" id="pd_amount" name='pd_amount' class="form-control" value="<c:out value='${product.pd_amount}'/>"
